var config = {
    ...
    age: "24",
    phone: "17342372349",
    email: "youngshilong@outlook.com",
    address: "现居陕西省西安市",
    qq: "1015236504",
    log: "Youngshilong",
    excpect_work: "C嵌入式开发",
    ...
    welcome: "你好，我是杨世龙，西安石油大学计科大三在读生<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫杨世龙，性别男，西安石油大学计科大三在读。我期望的工作岗位是C嵌入式开发。</p>" +
        "<p>我有着较多的C编程经验，计算机基础知识掌握扎实（最好和吹的一样），能够在工作中很好的完成自己的任务。此外，我有着充满激情的工作态度，团队协同作战能力强，同时我也具备独立开发的能力，擅于发现并解决问题。我的执行力强、责任感高、集体荣誉感强、敢于担当，不能够接受加班或出差等安排</p>" +
        "<p>十分期待与您的联系!</p>",
    ...
    */  
     ...
     * Resume-master\images\R-C.png
     */
  portfolio: [
      ["./images/R-C.png", "", "没东西", "<br>"],
       // ["", "", "", "<br>"],
    ...
    work: [
        // ["————————", "", "<p>暂无工作经历，期待您的联系。</p>"]
        ["2019/9 — 2021/9", "<br>95596",
            "<p><strong>95596</strong></p>" +
            "<p></p>"
        ],

        ["2019/9至今", "<br>西安石油大学",
            "<p><strong>油专</strong></p>" +
            "<p>淀粉厂</p>"
    ...
    icon: [
       // ["./svg/LeetCode.svg", "", "我的力扣主页"],
        ["./svg/github.svg", "https://github.com/YoungShiLong1113", "我的GitHub主页"],
